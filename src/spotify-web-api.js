...
var SpotifyWebApi = (function() {
   ...
   * @return {Object} Null if a callback is provided, a `Promise` object otherwise
   */
  Constr.prototype.getMyTopFiftyArtists = function(options, callback) {
    var requestData = {
      url: _baseUri + '/me/top/artists?limit=50&time_range=long_term'
    };
    return _checkParamsAndPerformRequest(requestData, options, callback);
  };
   ...
   * @return {Object} Null if a callback is provided, a `Promise` object otherwise
   */
  Constr.prototype.getMyTopFiftyTracks = function(options, callback) {
    var requestData = {
      url: _baseUri + '/me/top/tracks?limit=50&time_range=long_term'
    };
    return _checkParamsAndPerformRequest(requestData, options, callback);
  };
